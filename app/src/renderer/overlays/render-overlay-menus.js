...
function setEventHandlersForTabsMenu(tabList, bookmarks, isBookmarksOverlay = false) {
	...
	function addBookmarkOverlayControls(tabElement, tab) {
		...
		dwell(deleteBookmarkBtn, () => {
			...
			ipcRenderer.send('ipc-overlays-bookmarks-updated', bookmarks);
